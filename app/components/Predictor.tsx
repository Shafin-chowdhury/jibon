...
// Props type to allow callback after prediction
type PredictorProps = {
  onPredictSuccess?: (data: any) => void; // optional callback
};

export default function Predictor({ onPredictSuccess }: PredictorProps) {
