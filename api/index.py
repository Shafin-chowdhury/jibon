...
#         # 2. Advanced Mappings (Matches your GUI logic)
#         fatigue_map = {"None": 0, "Everyday": 1, "Every 3 days": 2, "Once a week": 3, "Once in 15 days": 4}
#         # Relation index starts at 1 for "Parent"
...
#         # 3. Model DataFrame (Exact names required for the columns)
#         feature_names = [
#             "Hb", "MCV", "MCH", "RDW", "RBC", 
...
#         # 4. Predict and Calculate Percentage
#         prob = model.predict_proba(input_df)[0][1]
#         percentage = round(float(prob) * 100, 2)  # Converts 0.8543 to 85.43
...
#             "percentage": f"{percentage}%", # Sends back "85.43%"
#             "probability": prob,
